---
title: "Everything you need to know about OpenMetrics 2.0!"
---
...
FOR REVIEWERS ONLY: We made this talk 3ppl: Bartek, Arthur and Krajo. if 2ppl is a must, Arthur and Krajo would be the preference (negotiable).
Also this talk covers most of the topic choices below, we picked internals and core development, but also be Prometheus fundamentals and philosophy, Integrating with Prometheus, Prometheus interoperability with OpenTelemetry could be valid.


### Speakers
[György Krajcsovits](../../speakers/györgy-krajcsovits)
